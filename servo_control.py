...
class ServoControlApp:
    ...
    def _build_connection_bar(self):
        ...
        tk.Label(inner, text="Connection", font=("Segoe UI", 10, "bold"),
        ...
        self.conn_btn = tk.Button(inner, text="\u25cf  Connect", font=("Segoe UI", 10, "bold"),
        ...
        self._status_lbl = tk.Label(inner, text="Disconnected", fg=SUBTEXT, bg=PANEL_BG, font=("Segoe UI", 9))
    ...
    def _build_servo_panel(self, parent):
        ...
        tk.Label(hdr, text="Actual", font=("Segoe UI", 9, "bold"),
    ...
    def _build_servo_row(self, parent, idx):
        ...
        tk.Button(row, text="Set", font=("Segoe UI", 11, "bold"),
    ...
    def _build_right_panel(self, parent):
        ...
        tk.Button(cmd_frame, text="Send", font=("Segoe UI", 9, "bold"),
                  bg=ACCENT, fg="#1e1e2e", activebackground=ACCENT,
        ...
        tk.Label(panel, text="Limits", font=("Segoe UI", 10, "bold"),
    ...
    def _build_arm_diagram(self, parent):
        ...
        inner.pack(fill="x")
        tk.Label(inner, text="Servo Control", font=("Segoe UI", 11, "bold"),
        ...
        self._reset_all_btn = tk.Button(
            reset_row, text="\u21BA Reset All", font=("Segoe UI", 11, "bold"),
            bg=ACCENT, fg="#1e1e2e", activebackground=ACCENT,
    ...
    def _build_traj_panel(self, parent):
        ...
        self.traj_record_btn = tk.Button(
            row1, text="\u25CF Record", font=("Segoe UI", 11, "bold"),
            bg=ACCENT, fg="#1e1e2e", activebackground=ACCENT,
            relief="flat", padx=14, pady=6, cursor="hand2",
            command=self._toggle_record)
        self.traj_record_btn.pack(side="left")
        self.traj_play_btn = tk.Button(
            row1, text="\u25B6 Play", font=("Segoe UI", 11, "bold"),
            bg=ACCENT, fg="#1e1e2e", activebackground=ACCENT,
            relief="flat", padx=14, pady=6, cursor="hand2",
            command=self._toggle_play)
        self.traj_play_btn.pack(side="left", padx=(6, 0))
        tk.Button(row1, text="\u23F9 Stop", font=("Segoe UI", 11, "bold"),
                  bg=ACCENT, fg="#1e1e2e", activebackground=ACCENT,
                  relief="flat", padx=14, pady=6, cursor="hand2",
                  command=self._stop_play).pack(side="left", padx=(6, 0))
        tk.Button(row1, text="Clear", font=("Segoe UI", 11, "bold"),
                  bg=ACCENT, fg="#1e1e2e", activebackground=ACCENT,
                  relief="flat", padx=14, pady=6, cursor="hand2",
        ...
        tk.Label(row3, text="ms/frame", font=("Segoe UI", 8),
