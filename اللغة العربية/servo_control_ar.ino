...
// ===================== أدوات الطباعة التسلسلية =====================
void printHelpInfo(){
  Serial.println("======== قائمة أوامر ذراع السيرفو ========");
  Serial.println("h        عرض المساعدة");
  Serial.println("s        طباعة الزوايا الحالية لجميع السيرفوهات الخمسة");
  Serial.println("90       تعيين هدف جميع السيرفوهات إلى 90");
  Serial.println("0 60     تعيين هدف S0 إلى 60");
  Serial.println("0 90 90 90 40 تعيين جميع الأهداف دفعة واحدة");
